...
The objective of a Sprint is to create potentially shippable deliverables, or product increments, \n\
which meet the Acceptance Criteria defined by the customer and Product Owner. \n\
These are considered Accepted Deliverables that may be released to the customer if they so desire. \n\
A list of Accepted Deliverables is maintained and updated after each Sprint Review Meeting. If a deliverable does not meet the defined',
        'Acceptance Criteria, it is not considered accepted and will usually be carried forward \n\
into a subsequent Sprint to rectify any issues. This is highly undesirable because the objective \n\
of every Sprint is for the deliverables to meet the criteria for acceptance.'
    ]
};
