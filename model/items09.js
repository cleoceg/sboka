...
var it_9224 = {
    ...
    texte: [
        'Cost estimation can be accomplished through the use of relative units (e.g., effort estimates) \n\
rather than absolute units (i.e., actual costs incurred). In order to estimate the cost to \n\
implement a User Story, the Scrum Team can use story points. When this is done, \n\
the cost estimated for each task will be in the form of story points, rather \n\
than monetary units. In order to do this successfully, the Scrum Team should \n\
identify a baseline User Story that all team members can relate to. Once this \n\
baseline is identified, all cost estimates for User Stories should be done compared \n\
to that baseline. These estimates remain fixed throughout a Sprint because teams are \n\
